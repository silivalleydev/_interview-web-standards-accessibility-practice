...
import { InputLabel, MenuItem, TablePagination, TextField } from '@material-ui/core'
import Select from '@mui/material/Select';

import { downloadAccountLog, getAccountLog } from '../api/log'
import { DateRangePicker } from 'react-dates'
import * as XLSX from 'xlsx';
import { Box, Button, FormControl, Grid, LinearProgress, Modal } from '@mui/material'
import { formatDateString, getFormattedDate } from '../utils/utils'


const UserAccountLogPage: React.FC = () => {
  ...
  const handleDownloadExcel = async (newPage) => {
    ...
    const result = await downloadAccountLog({
      adminId,
      content,
      fromCreatedAtStr,
      toCreatedAtStr,
  ...
  const handleGetActivityUser = async (newPage) => {
    ...
    const result = await getAccountLog({
      adminId,
      content,
      fromCreatedAtStr,
      toCreatedAtStr,
            ...
            <TableBody>
              {rows.map((row, idx) => (
                ...
                >
                  ...
                  <TableCell align="center">{row.targetId}</TableCell>
...
export default UserAccountLogPage
